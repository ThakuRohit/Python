...
NOTE: for constant n, the time complexity of code is O(n)2. Find the Duplicate Number:
...
NOTE: for constant n,
    ...
    Total time complexity of code is O(n logn).alternative approach ( USING ABS() )
...
Total time complexity is O(n).3. Largest Sum Contiguous Subarray (Kadane's Algorithm): 
...
Total time complexity is O(n)4. Rotate Array: 
...
Total time complexity is O(n)5.Merge Sorted Arrays: 
...
Total time complexity is O(n)6. Find Peak Element: 
...
Total time complexity is O(logn)7. Search in Rotated Sorted Array: 
...
Total time complexity is O(logn)8. Maximum Product Subarray: 
...
Total time complexity is O(n)9. Two Sum: 
...
Total time complexity is O(n)10. Move Zeroes: 
